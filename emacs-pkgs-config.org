...
#+begin_src emacs-lisp
  ...
  (add-hook 'scheme-mode-hook 'skribe-mode)
#+end_src
...
#+END_SRC
* Rcirc
Built-in Emacs IRC client
#+begin_src emacs-lisp
  (add-hook 'rcirc-mode-hook
            (lambda ()
              (rcirc-track-minor-mode 1)))

  ;; connect to servers using SSL/TLS
  (setq rcirc-server-alist
        '(("irc.freenode.net" :port 6697 :encryption tls
       :channels ("#rcirc" "#emacs" "#guile"))))
  ...
  ;; Change user info
  (setq rcirc-default-nick "avocadoras"
        rcirc-default-user-name ""
        rcirc-default-full-name "jon rostran")
